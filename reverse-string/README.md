<h2>344. Reverse String</h2><h3>Easy</h3><hr><div bis_skin_checked="1"><p>Write a function that reverses a string. The input string is given as an array of characters <code>s</code>.</p>
